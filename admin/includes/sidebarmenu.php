					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li><a href="add-bookings.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Add Booking</span><div class="clearfix"></div></a></li> 

									<li><a href="update-bookings.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Update Booking</span><div class="clearfix"></div></a></li> 

									<li><a href="delete-bookings.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Delete Booking</span><div class="clearfix"></div></a></li> 
