...
include('delete-bookings-config.php');
...
if(isset($_REQUEST["bkidDel"]))
{
	$bid=intval($_GET['bkidDel']);
	$sql = "DELETE FROM tblbooking WHERE BookingId=:bid";
	$query = $dbh->prepare($sql);
	$query-> bindParam(':bid',$bid, PDO::PARAM_STR);
	$query -> execute();
...
<td><a onclick="return confirm('Do you really want to delete booking')" href="delete-bookings.php?bkidDel=<?php echo htmlentities($result->bookid);?>">Delete</a></td>
